...
#define DATA_GPIO GPIO_A
#define CONTROL_GPIO GPIO_C

#define DB_OFFSET 4
#define DB_WIDTH 8
#define DB_MASK 0xff
#define DB_MODER_FULL_MASK 0xffff
#define DB_MODER_OUTPUT_MASK 0x5555
#define BUSYFLAG (DB_OFFSET+7)
#define BUSYFLAG_IDR_MASK (1 << BUSYFLAG)
#define RS 8
#define RW 9
#define E 10
